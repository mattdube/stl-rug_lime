---
title: "Next Generation Maching Learning in R"
subtitle: "with mlr3"
author: "Matt Dube"
...
- what we will be covering
  ...
  - several small examples, and
  - one demo that puts it all together
...
# mlr3 extension packages
```{r, echo=FALSE}
mlr3_ext <- data.table::fread(here::here("00_Data/raw/mlr3_package_list.csv"))
mlr3_planned <- data.table::fread(here::here("00_Data/raw/mlr3_planned.csv"))
```

```{r eval=require('DT'), tidy=FALSE, echo=FALSE}
DT::datatable(
  mlr3_ext,
  fillContainer = FALSE, options = list(pageLength = 15,dom = 't')
)
```
...
```{r load_data}
customerDT <- fread(here::here("00_Data/raw", 
...
```{r create_task}
tsk_cust <- TaskClassif$new(id = "churn", backend = customerDT, 
